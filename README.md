...
3. По каким критериям должен быть поиск в поисковой строке, на данный момент то, что введено в строку поиска, то и уходить на сервер и уже там сам **json server** ищит по этой строке.  
